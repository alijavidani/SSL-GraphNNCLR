...
def train_adasim(args):
    ...
    node_features_train = torch.zeros(50000, 192, device='cuda')  # Assuming 192 is the feature dimension
    node_features_val = torch.zeros(10000, 192, device='cuda')  # Assuming 192 is the feature dimension

    y_train = torch.zeros(50000, dtype=torch.long, device='cuda')
    y_val = torch.zeros(10000, dtype=torch.long, device='cuda')
