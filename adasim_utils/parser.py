...
def get_args_parser():
    ...
    parser.add_argument('--batch_size_per_gpu', default=75, type=int,
    ...
    parser.add_argument('--output_dir', default="./dino_cifar10_5/", type=str, help='Path to save logs and checkpoints.')
