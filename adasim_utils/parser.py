...
def get_args_parser():
    ...
    # Misc
    parser.add_argument('--data_path', default='E:\PhD\Datasets\cifar10-small', type=str,
                        help='Please specify path to the ImageNet training data.')
    parser.add_argument('--output_dir', default="./output2/", type=str, help='Path to save logs and checkpoints.')
    ...
    parser.add_argument('--untar_path', default='E:\PhD\Datasets\cifar10-small', type=str)
