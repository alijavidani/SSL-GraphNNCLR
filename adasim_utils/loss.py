...
class AdaSimLoss(nn.Module):
    ...
    def graph_consistency_loss(self, teacher_graph, student_graph, indices_batch_all, epoch):
        """
    ...
    def graph_consistency_loss2(self, teacher_node_embeddings, teacher_global_embedding,
        ...
        loss_local = F.kl_div(
            student_node_embeddings[indices_batch_all],
            teacher_node_embeddings[indices_batch_all],
            reduction='batchmean',
            log_target=False
        )
    ...
    @torch.no_grad()
    def update_centers(self, teacher_node_embeddings, teacher_global_embedding):
        # Update node center
